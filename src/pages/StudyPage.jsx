      ...
      <div className="sticky top-0 z-50 bg-white border-b-2 border-slate-200 shadow-sm px-4 py-3">
        <div className="max-w-4xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center space-x-3 sm:space-x-6 font-bold text-slate-600 text-sm sm:text-base">
            <div className="flex items-center text-orange-500"><Flame className="w-5 h-5 mr-1" /> 5</div>
            <div className="flex items-center text-blue-500"><Star className="w-5 h-5 mr-1" /> 120</div>
            <div className="flex items-center text-red-500"><Heart className="w-5 h-5 mr-1" /> 3</div>
          </div>
        </div>
      </div>
        ...
        {!selectedSubject ? (
          <>
            <div className="flex flex-col sm:flex-row items-center gap-6 mb-12 bg-white p-8 rounded-[2rem] border-2 border-b-8 border-slate-200">
              {/* MORRY MENYAMBUT ANAK-ANAK DI DASHBOARD */}
              ...
              {subjects.map((sub, i) => (
                ...
                >
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <div className="bg-yellow-100 text-yellow-600 font-bold px-3 py-1 rounded-full text-xs">+50 XP</div>
                  </div>
                  ...
                  {Object.keys(booksBySubject).map((subjectName) => (
                    <button
                      ...
                      className={`p-4 rounded-2xl border-2 border-b-4 transition-all flex flex-col items-center gap-2 font-black ${
                        activeLibrarySubject === subjectName ? "bg-blue-50 border-blue-300 text-blue-700" : "bg-white border-slate-200"
                      }`}
                    >
                      <span className="text-3xl">📚</span>
                      <span className="text-sm truncate w-full">{subjectName}</span>
                    </button>
                  ))}
                </div>
              </div>
          ...
          <div className="relative">
            <div className="flex items-center justify-between mb-12">
              <button 
                ...
                className="bg-white border-2 border-slate-200 border-b-4 rounded-xl px-4 py-2 font-black text-slate-500 flex items-center gap-2"
              >
                <ArrowLeft className="w-5 h-5" /> Back to Map
              </button>
              <h1 className="text-xl font-black uppercase">{selectedSubject.name} Expedition</h1>
            </div>
