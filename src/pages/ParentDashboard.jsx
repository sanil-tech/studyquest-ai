...
function ChildCard({ child, onRefresh }) {
  ...
  return (
    <>
      <Card className="p-5 bg-white hover:shadow-xl transition-all border-slate-200 relative overflow-hidden group rounded-2xl cursor-pointer shadow-sm border-slate-100 flex flex-col justify-between">
        <div>
