...
// IMPORT FUNGSI NAMA YANG SAMA DARI MYCHILDREN
...
function ChildCard({ child }) {
  ...
  // Menggunakan display_name yang telah diproses semasa loadData
    ...
    try {
      ...
      const kids = await Promise.all(
        childIds.map(async (id) => {
          ...
          return { 
            id, 
            ...childUser, // Menyalin semua data asal child
            display_name: getDisplayName(childUser), // Menggunakan utils yang sama!
            progress: progress?.[0] || {}, 
