...
export const DIAGNOSTIC_MODULES_META = [
  {
    ...
    title: "Mengira",
    icon: "🔢",
    subtitle: "Nombor, tambah, tolak, darab, bahagi, masa & wang",
    color: "amber",
    borderColor: "border-amber-500/40",
    levelMax: 5,
    description: "Nombor, tambah, tolak, darab, bahagi, masa & wang",
    skills: [
      "pre_number", "number_concept", "number_1_10", "number_sequence",
      "addition_10", "subtraction_10", "number_11_20", "addition_18",
      "subtraction_18", "number_50", "zero_concept", "addition_50",
      "subtraction_50", "number_100", "multiplication", "division",
      "time", "money", "problem_solving",
    ],
    skillDisplayNames: {
  ...
  },
  {
    ...
    title: "Membaca",
    icon: "📖",
    subtitle: "Huruf, suku kata, perkataan, ayat & pemahaman",
    color: "emerald",
    borderColor: "border-emerald-500/40",
    levelMax: 6,
    description: "Huruf, suku kata, perkataan, ayat & pemahaman",
    skills: [
      "lowercase_letters", "uppercase_letters", "vowels", "syllable_kv",
      "word_kv_kv", "word_v_kv", "word_kv_kv_kv", "word_kvk", "syllable_kvk",
      "word_v_kvk", "word_kv_kvk", "word_kvk_kv", "word_kvk_kvk",
      "word_kv_kv_kvk", "syllable_kvkk", "word_kv_kvkk", "word_v_kvkk",
      "word_kvk_kvkk", "word_kvkk_kv", "word_kvkk_kvk", "word_kvkk_kvkk",
      "word_kv_kv_kvkk", "word_kv_kvk_kvkk", "word_kvk_kv_kvkk",
      "word_kvkk_kv_kvk", "word_kv_kvkk_kvk", "diphthong", "diagraph",
      "sentence_reading", "comprehension",
    ],
    skillDisplayNames: {
  ...
  },
  {
    ...
    title: "Menulis",
    icon: "✏️",
    subtitle: "Tulisan tangan huruf, nombor, perkataan dan ayat",
    color: "blue",
    borderColor: "border-blue-500/40",
    levelMax: 3,
    description: "Tulisan tangan huruf, nombor, perkataan dan ayat",
    skills: [
      "write_lowercase", "write_uppercase", "write_numbers",
      "write_words_kv", "write_words_kvk", "write_sentence",
    ],
    skillDisplayNames: {
