...
export const CREATURES = [
  {
    ...
    stages: [
      { stage: 1, name: "Telur Numerix", xpRequired: 0, emoji: "🥚", description: "Telur bijak menanti di sarang pokok nombor.", animation: "bounce" },
      { stage: 2, name: "Menetas", xpRequired: 100, emoji: "🐣", description: "Numerix menetas! Mata besar mula membuka.", animation: "bounce" },
      ...
      { stage: 9, name: "Profesor Numerix", xpRequired: 4000, emoji: "🎓", description: "Sarjana matematik dikagumi semua.", animation: "pulse" },
  ...
  },
  {
    ...
    stages: [
      { stage: 1, name: "Telur Lexis", xpRequired: 0, emoji: "🥚", description: "Telur rubah tersembunyi di rak buku lama.", animation: "bounce" },
      { stage: 2, name: "Menetas", xpRequired: 100, emoji: "🐣", description: "Lexis menetas! Telinga tajam mendengar ABC.", animation: "bounce" },
      ...
      { stage: 9, name: "Profesor Lexis", xpRequired: 4000, emoji: "🎓", description: "Sarjana bahasa Inggeris.", animation: "pulse" },
  ...
  },
  {
    ...
    stages: [
      { stage: 1, name: "Telur Sparky", xpRequired: 0, emoji: "🥚", description: "Telur tikus makmal di belakang tabung uji.", animation: "bounce" },
      { stage: 2, name: "Menetas", xpRequired: 100, emoji: "🐣", description: "Sparky menetas! Hidung kecil sentiasa berbau.", animation: "bounce" },
      ...
      { stage: 9, name: "Profesor Sparky", xpRequired: 4000, emoji: "🎓", description: "Saintis muda yang cemerlang!", animation: "pulse" },
  ...
  },
  {
    ...
    stages: [
      { stage: 1, name: "Telur Shelldon", xpRequired: 0, emoji: "🥚", description: "Telur penyu kuno di runtuhan kuil.", animation: "bounce" },
      { stage: 2, name: "Menetas", xpRequired: 100, emoji: "🐣", description: "Shelldon menetas! Cengkerang mula terbentuk.", animation: "bounce" },
      ...
      { stage: 9, name: "Profesor Shelldon", xpRequired: 4000, emoji: "🎓", description: "Sejarawan yang bijaksana.", animation: "pulse" },
  ...
  },
  {
    ...
    stages: [
      { stage: 1, name: "Telur Skyler", xpRequired: 0, emoji: "🥚", description: "Telur helang di puncak gunung tertinggi.", animation: "bounce" },
      { stage: 2, name: "Menetas", xpRequired: 100, emoji: "🐣", description: "Skyler menetas! Sayap kecil berkembang.", animation: "bounce" },
      ...
      { stage: 9, name: "Profesor Skyler", xpRequired: 4000, emoji: "🎓", description: "Penjelajah dunia sejati!", animation: "pulse" },
  ...
  },
  {
    ...
    stages: [
      { stage: 1, name: "Telur Rimau", xpRequired: 0, emoji: "🥚", description: "Telur harimau di gua sastera kuno.", animation: "bounce" },
      { stage: 2, name: "Menetas", xpRequired: 100, emoji: "🐣", description: "Rimau menetas! Belang mula terbentuk.", animation: "bounce" },
      ...
      { stage: 9, name: "Profesor Rimau", xpRequired: 4000, emoji: "🎓", description: "Sasterawan yang dikagumi.", animation: "pulse" },
